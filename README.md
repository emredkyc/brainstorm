<div align="center">
  <br />
    <a href="" target="_blank">
      <img src="https://i.ibb.co/Twfzgq4/brainstorm.png" alt="Project Banner">
    </a>
  <br />
...
Brainstorm - Modern UI/UX website, developed using React.js and Tailwind CSS, exemplifies modern UI/UX principles. Its sleek design, seamless animations, and overall user experience set a high standard, serving as a reference or inspiration for future modern applications or websites in general.
...
```bash
git clone https://github.com/emredkyc/brainstorm.git
cd brainstorm
```
...
export const brainstormServices = [
  "Photo generating",
  "Photo enhance",
  "Seamless Integration",
];

export const brainstormServicesIcons = [
  recording03,
  recording01,
  disc02,
  chromecast,
